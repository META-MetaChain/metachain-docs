...
Integrating with Supra's price feeds is quick and easy. Supra currently supports several Solidity/EVM-based networks, like metachain, and non-EVM networks like Sui, Aptos.
...
For metachain, the address is [0x8a358F391d93f7558D5F5E61BDf533e2cc3Cf7a3](https://metachain-i.co/address/0x8a358f391d93f7558d5f5e61bdf533e2cc3cf7a3)

When you have the proper address, create an instance of the S-Value feed using the interface we previously defined for metachain:
