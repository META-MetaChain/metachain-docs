...
description: Learn how to run an metachain local dev node on your local machine.
author: jose-franco
sme: jose-franco
...
A local metachain Nitro dev node can help you deploy and test smart contracts in a fully controlled environment. This how-to walks you through the process of deploying and running a full development environment on your local machine that includes a Nitro dev node, a dev-mode geth L1, and multiple instances with different roles.
