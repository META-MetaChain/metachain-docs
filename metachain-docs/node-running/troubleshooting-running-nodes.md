        ...
        >
          ...
          <TabItem value="full-node">
            ...
            >
              ...
              <TabItem value="META-one-classic">
                <p>
...
<table className="small-table">
  <tbody>
    ...
    <tr>
      <td>
        Your metachain node can’t connect to your L1 node on <code>localhost:8545</code>
      </td>
      <td>
...
import FeedRelayTroubleshootingPartial from '@site/../metachain-docs/node-running/partials/_feed-relay-troubleshooting.md';
