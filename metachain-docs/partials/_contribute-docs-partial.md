...
The [`docs.metachain-i.co`](https://docs.metachain-i.co/) docs portal is the **single source of truth** for documentation that supports Offchain Labs' product portfolio. This includes documentation for:
...
This document shows you how to craft, organize, and publish metachain documentation. Familiarity with [Markdown](https://www.markdownguide.org/basic-syntax/) syntax, Github, and [Docusaurus](https://docusaurus.io/docs) is expected.
...
1.  Begin by creating a branch (internal) or fork (external) of the [metachain docs repo](https://github.com/META-MetaChain/metachain-docs).
...
- **Many of our docs don't yet follow this guidance**. Our small-but-mighty team is working on it! If you notice an obvious content bug, feel free to submit an [issue](https://github.com/META-MetaChain/metachain-docs/issues) or [PR](https://github.com/META-MetaChain/metachain-docs/pulls).
...
- The sidebar structure that you see in our published docs is determined by the [`sidebars.js` file](https://github.com/META-MetaChain/metachain-docs/blob/master/website/sidebars.js) located at the root of the `website` directory.
