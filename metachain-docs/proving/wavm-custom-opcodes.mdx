...
These invariants are maintained by WASM validation and METAitrator codegen. (See [One Step Proof Assumptions](/proving/osp-assumptions.mdx).)
...
| 0x8003 | METAitraryJumpIf         | Pops an i32 from the stack. If non-zero, jumps to the program counter in the argument data.                                                                                                                                 |
