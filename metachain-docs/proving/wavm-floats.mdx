...
(meaning both a Rust METAitrator implementation and Solidity OSP implementation)
...
METAitrator links other WAVM guests against this,
...
This ensures that floating point operations are deterministic and consistent between METAitrator and the OSP,
