...
This document provides an in-depth overview of the features provided by the [Stylus Rust SDK](https://github.com/META-MetaChain/stylus-sdk-rs). For information about deploying Rust smart contracts, see the `cargo stylus` [CLI Tool](https://github.com/META-MetaChain/cargo-stylus). For a conceptual introduction to Stylus, see [Stylus: A Gentle Introduction](../stylus-gentle-introduction.md). To deploy your first Stylus smart contract using Rust, refer to the [Quickstart](../stylus-quickstart.md).
...
```rust
#[entrypoint]
fn entrypoint(calldata: Vec<u8>) -> METAResult {
    // bytes-in, bytes-out programming
}
```
...
[abi_export]: https://github.com/META-MetaChain/cargo-stylus#exporting-solidity-abis
...
[erc20]: https://github.com/META-MetaChain/stylus-sdk-rs/blob/stylus/examples/erc20/src/main.rs
